...
console.log('--- STARTING STANDALONE WEBHOOK TEST V3 ---');

if (!process.env.AWS_RDS_POSTGRES_URL) {
    console.error('❌ Error: AWS_RDS_POSTGRES_URL not found in .env.local');
    process.exit(1);
}

console.log(`🔗 Connecting to database: ${process.env.AWS_RDS_POSTGRES_URL.split('@')[1]}`);
