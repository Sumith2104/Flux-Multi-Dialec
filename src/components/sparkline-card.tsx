...
export function SparklineCard({ title, value, subtitle, type, color, data }: SparklineCardProps) {
    return (
        <Card className="w-52 h-52 flex flex-col justify-between relative overflow-hidden group border-zinc-800/80 bg-zinc-900/40 backdrop-blur-md shadow-lg transition-colors hover:bg-zinc-900/60">
